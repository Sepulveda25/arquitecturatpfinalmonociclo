...
//Date        : Mon Aug 19 14:53:51 2019
//Host        : DESKTOP-FBRH79C running 64-bit major release  (build 9200)
//Command     : generate_target InstrMem.bd
//Design      : InstrMem
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "InstrMem,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=InstrMem,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "InstrMem.hwdef" *) 
module InstrMem
   ();


  InstrMem_blk_mem_gen_0_1 blk_mem_gen_0
